...
<title>Dealer Registeration</title>
<link rel="stylesheet" href="/ims/resources/static/css/register.css">
</head>
<body>
<div class="form">
<h3>Dealers Registration</h3>
<form:form id="registrationform" action="saveDealer" method="post" modelAttribute="dealer">
...
<input id="pincode" name="pincode" placeholder="Enter Pin Code" required tabindex="9" type="text">
<br>
