...
public class ProductController {
	...
	List<Product> listProducts = pService.listAll();//invokes findAll method of a crudRepository
	...
	Product product = pService.get(id);//Fetches single record based on id
	...
	pService.delete(id);//Deletes Record based on ID
	return "redirect:products";
	}
