...
public class LoginController {
	...
	public ModelAndView loginDealer(HttpServletRequest req,@ModelAttribute("dealer") Dealer dealer) {
		...
		Dealer d=lService.findByEmail(email);//fetch records /object from table matching email id
		if(d==null) {
		...
		List<Product> listProducts=pService.listAll();//fetches all record from product
